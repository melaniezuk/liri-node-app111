...
function retrieveTweets() {                                          // retrieveTweets will retrieve my last 20 tweets and display them together with the date
    ...
    //can't use, other's code
    //var params = {screen_name: '_angrbrd', count: 20};               //Set the 'screen_name' to my Twitter handle
	
	//client.get('statuses/user_timeline', params, function(error, tweets, response) {    // Retrieve the last 20 tweets
		/*if (error) {
